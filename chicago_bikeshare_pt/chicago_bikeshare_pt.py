...
for data_element in data_list[:20]:
  print(data_element)
...
for data_element in data_list:
  if data_element[-2] == 'Male':
    male += 1
  elif data_element[-2] == 'Female':
    female += 1
...
answer = "Pois existem linhas(samples) que o valor do gênero é uma string vazia."
